...
| Give model score and New-device status little weight | In the selected closed-case history, cleared cases averaged a 0.881 model score and 83.2% had New identity status. These are weak standalone signals in this dataset. | Selection bias means the historical rates cannot be used as direct probabilities. |
